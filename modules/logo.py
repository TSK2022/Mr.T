...
==============================================={nc}''')
  ...
  def not_ins(self):
    self.tool_header()
    print (f'''
{cyan}  [ + ]  {red}We can't install Mr.TSK.
...
{red} If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print (f'''
{yellow}    [ + ] {green}Mr.TSK installed successfully.
{yellow}    [ + ] {green}To run Mr.TSK,
{yellow}    [ + ] {green}Type Mr.TSK in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print (f'''
{yellow}  [ 1 ] {green}Update your Mr.TSK.
{yellow}  [ 0 ] {green}For Back.{nc}''')
  ...
  def updated(self):
    self.tool_header()
    print (f'''
{yellow}      [ + ] {green}Mr.TSK Updated Successfully.
...
{cyan}  [ + ]  {red}Please try again after some time.{nc}''')
  ...
  def update_error(self):
    self.tool_header()
    print (f'''
{red}  [ + ]  {red}We can't Update Mr.TSK.\033[1;m
...
{yellow}|  00) Back                                   |
 \033[01;36m============================================={nc}""")
  ...
  def updating(self):
    print (f"""{yellow} =============================================
{green}|______________ Updating Mr.TSK ______________|
 {yellow}============================================={nc}""")
...
{yellow}  [ x ] {green}For Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print (f'''
{yellow}         [ + ] {green}Thanks for using Mr.TSK
