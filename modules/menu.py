        ...
        if system.connection():
          ...
          if system.sudo != None:
            if os.path.exists(system.home+"/Mr.TSK"):
              ...
              os.system(system.sudo+" git clone https://github.com/TSK2022/Mr.TSK.git "+system.home+"/Mr.TSK")
            ...
            if os.path.exists(system.home+"/Mr.TSK"):
              ...
              os.system("git clone https://github.com/TSK2022/Mr.TSK.git "+system.home+"/Mr.TSK")
            if os.path.exists(system.home+"/Mr.TSK/install.aex"):
