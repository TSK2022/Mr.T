...
class main:
  def install_tools(self):
    while True:
      ...
      print(f"")
      logo.back()
      cmd=input(f"{blue}Mr.TSK{nc}@{blue}space {yellow}$ {nc}")
        ...
        try:
          if int(cmd) in range(1,int(total)+1):
            while True:
              ...
              print(f"")
              logo.back()
              tcmd=input(f"{blue}Mr.TSK{nc}@{blue}space {yellow}$ {nc}")
    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection():
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Mr.TSK"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/rajkumardusad/Mr.TSK.git "+system.home+"/Mr.TSK")
            if os.path.exists(system.home+"/Mr.TSK/install.aex"):
              os.system("cd "+system.home+"/Mr.TSK && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Mr.TSK"):
              ...
              os.system("git clone https://github.com/rajkumardusad/Mr.TSK.git "+system.home+"/Mr.TSK")
            if os.path.exists(system.home+"/Mr.TSK/install.aex"):
              os.system("cd "+system.home+"/Mr.TSK && sh install.aex")
              if os.path.exists(system.bin+"/Mr.TSK") and os.path.exists(system.conf_dir+"/Mr.TSK"):
                os.system("clear")
                logo.updated()
                cmd=input(f"{blue}Mr.TSK{nc}@{blue}space {yellow}$ {nc}")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall Mr.TSK" or cmd=="unistall Mr.TSK":
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Mr.TSK")
          os.system(system.sudo+" rm -rf "+system.bin+"/toolx")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Mr.TSK")
        else:
          os.system("rm -rf "+system.bin+"/Mr.TSK")
          os.system("rm -rf "+system.bin+"/toolx")
          os.system("rm -rf "+system.conf_dir+"/Mr.TSK")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Mr.TSK/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Mr.TSK/core/cat.json") as cat_file:
